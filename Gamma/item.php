...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" id="gamma-lambda-cam">
	<head>
		...
		<link id="ctl00_Imports" rel="stylesheet" type="text/css" href="/CSS/GammaCSS.css?t=<?= time() ?>">
		...
		<script src="/js/jquery.js?t=<?= time() ?>" type="text/javascript"></script>
		<script src="/js/Gamma/WebResource.js" type="text/javascript"></script>
		<script src="/js/Gamma/PlaceLauncher.js" type="text/javascript"></script>
		<?php if($admin_view): ?>
			<script>
						...
						<div id="Item">
							...
							<div id="Details">
								<div id="Summary">
									...
									<div id="ReportAbuse">
										<div id="ctl00_cphRoblox_AbuseReportButton1_AbuseReportPanel" class="ReportAbusePanel">
											<span class="AbuseIcon"><a id="ctl00_cphRoblox_AbuseReportButton1_ReportAbuseIconHyperLink" href="AbuseReport/AssetVersion.aspx?ID=2299151&amp;ReturnUrl=%2fItem.aspx%3fID%3d2018209"><img src="/images/Gamma/abuse.PNG" alt="Report Abuse" border="0"></a></span>
								...
								<div id="Configuration">
									<a href="/Gamma/My/Item.aspx?ID=<?= $item_id ?>">Configure this <?= $category ?></a>
									<?php if($admin_view): ?>
								...
								<?php if($item instanceof Place && $item->type == AssetType::PLACE): ?>
									<div id="Thumbnail_Place">
										<a id="ctl00_cphRoblox_AssetThumbnailImage_Place" disabled="disabled" title="<?= $item->name ?>" onclick="return false" style="display:inline-block;">
											<img src="<?= $asset_thumburl ?>" border="0" alt="<?= $item->name ?>" blankurl="http://t1.roblox.com:80/blank-420x230.gif" style="width:420px;height:230px;">
										</a>
									</div>
									...
									<div id="ctl00_cphRoblox_PlayGames" class="PlayGames">
										<div style="text-align: center; margin: 1em 5px;">
											...
											<?php if(!$friends_with): ?>
											<span style="display:inline"><img src="/images/Gamma/locked.png" alt="Locked" border="0">&nbsp;Friends-only</span>
											<?php endif ?>
											<?php if($friends_with): ?>
											<span style="display:inline"><img src="/images/Gamma/unlocked.png" alt="Unlocked" border="0">&nbsp;Friends-only: You have access</span>
											<?php endif ?>
											<?php endif ?>
											<?php if(!$item->friends_only): ?>
											<span style="display:inline"><img src="/images/Gamma/public.png" alt="Public" border="0">&nbsp;Public</span>
											<?php endif ?>
											<img src="/images/Gamma/<?= $copylabel ?>.png" alt="<?= $copylabel ?>" border="0">
																	...
																	<div class="$alt">
																		...
																		<div class="Post">
																			...
																			<div class="ReportAbusePanel">
																				<span class="AbuseIcon"><a href="AbuseReport/AssetVersion.aspx?ID=2299151&amp;ReturnUrl=%2fItem.aspx%3fID%3d2018209"><img src="/images/Gamma/abuse.PNG" alt="Report Abuse" border="0"></a></span>
						...
						<div id="ctl00_cphRoblox_ItemPurchasePopupUpdatePanel">
							...
							<div id="ProcessPurchase_Free" style="display:none">
								<div id="Processing_Free">
									<img id="ctl00_cphRoblox_ProcessingFreePurchaseIconImage" src="/images/Gamma/ProgressIndicator2.gif" alt="Processing..." align="middle" style="border-width:0px;" />&nbsp&nbsp;
