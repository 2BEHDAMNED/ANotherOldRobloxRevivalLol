...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" id="gamma-lambda-cam">
	...
	<body>
		<form name="aspnetForm" method="post" action="Default.aspx" id="aspnetForm">
			<div id="Container">
				<?php include $_SERVER['DOCUMENT_ROOT'].'/core/ui/gamma/header_nonav.php'; ?>
				<div id="Body">
					...
					<div style="margin-top: 12px; margin-bottom: 12px">
						...
						<img id="ctl00_cphRoblox_Image3" class="Bullet" src="/images/Gamma/BuildIcon.png" border="0">
						...
						<img id="ctl00_cphRoblox_Image4" class="Bullet" src="/images/Gamma/FriendsIcon.png" border="0">
						<div id="InstallStep2" style="padding-left: 60px">
							<h2>
								...
								<p>
									<img id="ctl00_cphRoblox_Image1" src="/images/Gamma/Install/DownloadPrompt.PNG" border="0">
								</p>
							</h2>
						</div>
						<img id="ctl00_cphRoblox_Image5" class="Bullet" src="/images/Gamma/BattleIcon.png" border="0">
						<div id="InstallStep3" style="padding-left: 60px">
							...
							<p>
								<img id="ctl00_cphRoblox_Image2" src="/images/Gamma/Install/Wizard.PNG" border="0">
							</p>
						</div>
					</div>
					<script>
