...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form name="aspnetForm" method="post" action="LaunchGame.aspx" id="aspnetForm">
			<div id="Container">
				<?php include_once $_SERVER["DOCUMENT_ROOT"]."/core/ui/gamma/header_nonav.php"; ?>
				<div id="Body">
					<div id="ctl00_cphGamma_BrowserMessage" align="center">
						...
						<p><img id="ctl00_cphGamma_iGammaViaStartMenu" src="/images/Gamma/GammaViaStartMenu.png" alt="GAMMA via START menu" border="0"></p>
						<p>&nbsp;</p>
					</div>
				</div>
