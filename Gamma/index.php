						...
						<div id="RobloxAtAGlance">
							...
							<div id="Showcase">
								...
								<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="400" height="326" align="middle">
									<param name="movie" value="/images/Gamma/PlayTrailer.swf">
									<param name="quality" value="high">
									<embed src="/images/Gamma/PlayTrailer.swf" width="400" height="326" align="middle" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash">
								</object>
								<?php endif ?>
								<?php if(!($ie6 || $ie7 || $ie8)): ?>
								<video width="400" height="326" controls>
									<source src="/images/Gamma/ChristmasDemoFinal.mp4" type="video/mp4">
							...
							<div id="ctl00_cphRoblox_pForParents">
								<div id="ForParents">
									<a id="ctl00_cphRoblox_hlKidSafe" title="GAMMA is NOT kid-safe!" href="Parents.aspx" style="display:inline-block;"><img title="GAMMA is NOT kid-safe!" src="/images/Gamma/anti-coppa.jpg" border="0"></a>
								</div>
							</div>
						</div>
