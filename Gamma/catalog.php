...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" id="gamma-lambda-cam"><!-- MachineID: App1 -->
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/CSS/GammaCSS.css">
		<link rel="Shortcut Icon" type="image/ico" href="/gammafavicon.ico">
		...
		<script src="/js/Gamma/WebResource.js" type="text/javascript"></script>
	</head>
	<body>
		<form name="aspnetForm" method="post" action="Catalog.aspx?m=<?= $mode ?>&amp;c=<?= $categoryid ?>" id="aspnetForm">
			<div id="Container">
				...
				<?php include_once $_SERVER["DOCUMENT_ROOT"]."/core/ui/gamma/header.php"; ?>
				<div id="Body">
					<div id="CatalogContainer">
						...
						<div class="DisplayFilters">
							...
							<div id="BrowseMode">
								...
								<ul>
									<li>
										<?php if($mode == "TopFavorites"): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
									...
									<li>
										<?php if($mode == "BestSelling"): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
									...
									<li>
										<?php if($mode == "RecentlyUpdated"): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
									...
									<li>
										<?php if($mode == "ForSale"): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
									...
									<li>
										<?php if($mode == "PublicDomain"): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
							...
							<div id="Category">
								...
								<ul>
									<li>
										<?php if($category == 2): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
										<a href="Catalog.aspx?m=<?= $mode ?>&amp;c=2&amp;t=<?= $time_period ?>&amp;d=All">T-Shirts</a>
									</li>
									<li>
										<?php if($category == 11): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
										<a href="Catalog.aspx?m=<?= $mode ?>&amp;c=11&amp;t=<?= $time_period ?>&amp;d=All">Shirts</a>
									</li>
									<li>
										<?php if($category == 12): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
										<a href="Catalog.aspx?m=<?= $mode ?>&amp;c=12&amp;t=<?= $time_period ?>&amp;d=All">Pants</a>
									</li>
									<li>
										<?php if($category == 8): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
										<a href="Catalog.aspx?m=<?= $mode ?>&amp;c=8&amp;t=<?= $time_period ?>&amp;d=All">Hats</a>
									</li>
									<li>
										<?php if($category == 13): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
										<a href="Catalog.aspx?m=<?= $mode ?>&amp;c=13&amp;t=<?= $time_period ?>&amp;d=All">Decals</a>
									</li>
									<li>
										<?php if($category == 10): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
										<a href="Catalog.aspx?m=<?= $mode ?>&amp;c=10&amp;t=<?= $time_period ?>&amp;d=All">Models</a>
									</li>
									<li>
										<?php if($category == 9): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
							...
							<div id="ctl00_cphRoblox_rbxCatalog_Timespan">
								...
								<ul>
									<li>
										<?php if($time_period == "PastHour"): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
									...
									<li>
										<?php if($time_period == "PastDay"): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
									...
									<li>
										<?php if($time_period == "PastWeek"): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
									...
									<li>
										<?php if($time_period == "PastMonth"): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>	
									...
									<li>
										<?php if($time_period == "AllTime"): ?><img class="GamesBullet" src="/images/Gamma/games_bullet.png" border="0"><?php endif ?>
					...
					<?php include_once $_SERVER["DOCUMENT_ROOT"]."/core/ui/gamma/footer.php"; ?>
				</div>
