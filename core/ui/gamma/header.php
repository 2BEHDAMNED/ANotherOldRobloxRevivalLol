...
<div id="Header">
	<div id="Banner" style="font-family: sans-serif;">
		...
		<div id="Logo" style="margin-bottom: -4px;">
			<a id="ctl00_rbxImage_Logo" title="GAMMA" href="/Gamma/Default.aspx" style="display:inline-block;height:70px;width:267px;cursor:pointer;">
				<img src="/images/Gamma/logo.png" border="0" id="img" alt="GAMMA" style="margin-top:-5px; height:69px;">
			</a>
		</div>
									...
									<div id="ctl00_rbxAlerts_MessageAlertPanel">
										<div id="MessageAlert">
											<a id="ctl00_rbxAlerts_MessageAlertIconHyperLink" class="MessageAlertIcon" href="/My/Inbox.aspx">
												<img src="/images/Gamma/Message.png" style="border-width:0px;">
											</a>&nbsp;
									...
									<div id="ctl00_rbxAlerts_TicketsAlertPanel">
										<div id="TicketsAlert">
											<a id="ctl00_rbxAlerts_TicketsAlertIconHyperLink" class="TicketsAlertIcon" href="/My/AccountBalance.aspx">
												<img src="/images/Gamma/Tux.png" style="border-width:0px;">
											</a>&nbsp;
	...
	<div class="Navigation">
		<span><a id="ctl00_hlMyRoblox" class="MenuItem" href="/Gamma/User.aspx">My GAMMA</a></span>
		<span class="Separator">&nbsp;|&nbsp;</span>
		<span><a id="ctl00_hlGames" class="MenuItem" href="/Gamma/Games.aspx">Games</a></span>
		<span class="Separator">&nbsp;|&nbsp;</span>
		<span><a id="ctl00_hlCatalog" class="MenuItem" href="/Gamma/Catalog.aspx">Catalog</a></span>
		<span class="Separator">&nbsp;|&nbsp;</span>
		<span><a id="ctl00_hlBrowse" class="MenuItem" href="/Gamma/Browse.aspx">People</a></span>
		<span class="Separator">&nbsp;|&nbsp;</span>
		<span><a id="ctl00_hlHelp" class="MenuItem" href="/Gamma/Help.aspx" target="_blank">Help</a></span>
	</div>
...
<div id="ctl00_cphRoblox_VisitButtons_rbxPlaceLauncher_Panel1" class="modalPopup" style="display: none">
	<div style="margin: 1.5em">
		<div id="Spinner" style="float:left;margin:0 1em 1em 0">
			<img id="ctl00_cphRoblox_rbxUserPlacesPane_ctl02_rbxPlatform_rbxVisitButtons_rbxPlaceLauncher_Image1" src="/images/Gamma/ProgressIndicator2.gif" alt="Progress" border="0">
		</div>
