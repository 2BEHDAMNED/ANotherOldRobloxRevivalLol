...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body bgcolor="buttonface" scroll="no">
		<form name="PublishContent" method="post" action="/IDE/Gamma/Upload.aspx" id="PublishContent">
	...
	<body bgcolor="buttonface" scroll="no">
		<form name="PublishContent" method="post" action="Upload.aspx" id="PublishContent">
			...
			<script type="text/javascript">
				function uploadData() {
					try {
						window.external.Write().Upload("http://<?= $domain ?>/Data/Upload.ashx?assetid=0&type=Place&name=<?= $name ?>&description=<?= $desc ?>&ispublic=<?= $ispublic ?>&iscopylocked=<?= $iscopylocked ?>&year=2008");
	...
	<body bgcolor="buttonface" scroll="no">
		<form name="PublishContent" method="post" action="Upload.aspx" id="PublishContent">
			...
			<script type="text/javascript">
				function uploadData() {
					try {
						window.external.Write().Upload("http://<?= $domain ?>/Data/Upload.ashx?assetid=<?= $placeid ?>&type=Place&name=&description=&ispublic=False&year=2008");
						document.getElementById("Uploading").style.display='none';
						document.getElementById("Confirmation").style.display='block';
					} catch (ex) {
						window.alert(ex.message);
