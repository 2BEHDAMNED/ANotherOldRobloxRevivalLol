	...
	<body>
		<div class="Game" template>
			...
			<div id="Info">
				...
				<span style="font-weight: bold;letter-spacing: 1px;font-size:11px"><b id="ActivePlayerCount" style="letter-spacing: 0;">10</b> Player<span id="Plural">s</span> online...</span>
			</div>
		</div>
		<div id="Container">
