	...
	<body>
		<div class="Game" template>
			...
			<div id="Info">
				...
				<div style="font-weight: bold;letter-spacing: 1px;font-size:10px;color:#aaa">
					<span id="ActivePlayerCountLabel"><b id="ActivePlayerCount" style="letter-spacing: 0;">0</b> Player<span id="Plural">s</span> online...</span><br>
					<span id="VisitCountLabel"><b id="VisitCount" style="letter-spacing: 0;">0</b> Visit<span id="Plural">s</span></span>
				</div>
