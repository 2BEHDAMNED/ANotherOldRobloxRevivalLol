...
ANORRL.User = {
	CurrentUserBadgesPage: 1,
	AdvanceFeed: function() {
		this.GrabFeed(this.CurrentUserBadgesPage + 1);
	},
	...
	GrabFeed: function(page) {
		...
		$.get("/api/feeds", {p : page}, function(data) {
			...
			ANORRL.User.CurrentUserBadgesPage = data['page'];
			var current_page = ANORRL.User.CurrentUserBadgesPage;
