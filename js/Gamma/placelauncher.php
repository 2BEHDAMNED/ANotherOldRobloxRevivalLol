			...
			window.setTimeout(function() {
				...
				if ("ActiveXObject" in window) {
					try {
						...
						workspace.ExecUrlScript("http://<?= $domain ?>/game/gamma/join.ashx?serverPort="+data);
	...
	window.setTimeout(function() {
		...
		if ("ActiveXObject" in window) {
			try {
				...
				workspace.ExecUrlScript("http://<?= $domain ?>/game/gamma/join.ashx?serverPort="+id);
	...
	window.setTimeout(function() {
		...
		if ("ActiveXObject" in window) {
			try {
				...
				workspace.ExecUrlScript("http://<?= $domain ?>/game/gamma/visit.ashx?placeID="+place_id);
	...
	window.setTimeout(function() {
		...
		if ("ActiveXObject" in window) {
			try {
				...
				workspace.ExecUrlScript("http://<?= $domain ?>/game/gamma/edit.ashx?placeID="+place_id);
